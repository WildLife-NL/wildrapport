...
void main() {
  ...
  setUp(() {
    ...
    ConnectionChecker.setHasInternetConnection = MockConnectionChecker.hasInternetConnection;
  });
  ...
  group('ResponseManager', () {
    ...
    test('should submit responses when online', () async {
      ...
      final responsesListObject = ResponsesListObject(responses: [
    ...
    */
    ...
    test('should handle malformed JSON in responses list', () async {
      ...
      await prefs.setStringList('responses', []); // Set empty list instead of invalid JSON
    ...
    test('should handle multiple responses for different questionnaires', () async {
      // Arrange
