...
void main() {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      when(mockLoginInterface.sendLoginCode('test@example.com')).thenAnswer((
        _,
      ) async {
  ...
  testWidgets('should handle exception during login code request', (
    ...
    expect(
      foundLoginField || foundVerificationScreen,
      isTrue,
      reason:
          'App should either show login field or verification screen after error',
    );
