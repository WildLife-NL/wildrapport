...
void main() {
  ...
  group('RapporterenScreen', () {
    testWidgets('should render all report buttons', (
      WidgetTester tester,
    ) async {
      // Arrange
    ...
    testWidgets(
      'should navigate to BelongingDamagesScreen when Gewasschade is pressed',
      (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createRapporterenScreen());
        await tester.pumpAndSettle();
    ...
    testWidgets(
      'should navigate to AnimalsScreen when Diergezondheid is pressed',
      (WidgetTester tester) async {
        // Arrange
        await tester.pumpWidget(createRapporterenScreen());
        await tester.pumpAndSettle();
    ...
    testWidgets('should show snackbar when Verkeersongeval is pressed', (
      ...
      await tester
          .pumpAndSettle(); // Use pumpAndSettle to allow SnackBar to appear
