  ...
  group('AnimalGrid Widget Tests', () {
    testWidgets('should display all animals in grid', (
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: AnimalGrid(animals: testAnimals, onAnimalSelected: (_) {}),
          ),
        ),
      );
    ...
    testWidgets('should call onAnimalSelected when an animal is tapped', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('should handle empty animal list', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: AnimalGrid(animals: [], onAnimalSelected: (_) {}),
          ),
        ),
      );
