  ...
  group('CounterWidget Tests', () {
    testWidgets('should display initial count', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: AnimalCounter(name: "Test", onCountChanged: (_, count) {}),
          ),
        ),
      );
    ...
    testWidgets('should call onCountChanged when + button is pressed', (
      WidgetTester tester,
    ) async {
      int newCount = 0;
      String animalName = "";
    ...
    testWidgets('should not allow decrement below 0', (
      WidgetTester tester,
    ) async {
      int newCount = -1;
